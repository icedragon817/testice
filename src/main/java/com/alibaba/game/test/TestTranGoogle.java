...
public class TestTranGoogle {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //TestTranGoogle g = TestTranGoogle.getInstance();
    ...
    private static TestTranGoogle _instance = null;

    /**
     * 获取单例
     * @return
     */
    public static TestTranGoogle getInstance() {
        if( null == _instance){
            _instance = new TestTranGoogle();
            _instance.init();
        }
        return _instance;
    }
